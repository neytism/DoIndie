...
<body style="background-repeat: no-repeat center center fixed;">
    ...
    <!-- PRODUCTS SECTION -->
    <div class="col-md-6">
        <h1 style="color: #423329; font-size: 120px; margin-bottom: 15px; text-align:right; margin-right: 0;"><?= htmlspecialchars($data['searched_user']['artist_display_name']) ?></h1>
        <div class="products">
            <?php foreach ($data['product_categories'] as $category): ?>
                ...
                foreach ($data['searched_user_products'] as $product) {
